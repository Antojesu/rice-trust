        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="social-icons">
                    <a href="#"><img src="facebook.png" height="25"></a>
                    <a href="#"><img src="instagram.png" height="25"></a>
    ...
    <header class="header">
      <div class="container">
          <div class="row align-items-center">
              ...
              <!-- Contact and Public Disclosure -->
              <div class="col-md-8 text-md-end text-center contact-info">
                  <a href="donation.html" class="btn btn-warning me-3">DONATE NOW</a>
                  <a href="tel:+919965540741" class="me-3 text-dark">Call Us: +91-996-5540741</a>
                  <a href="mailto:tmsrajan@yahoo.co.in" class="me-3 text-dark">Email:tmsrajan@yahoo.co.in</a>
                  <a href="dash.html" class="me-3 text-dark">ADMIN</a>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="profile.html" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Organisation Profile
              </a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="profile.html">PROFILE</a></li>
                <li><a class="dropdown-item" href="objective.html">OBJECTIVES</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="histroy.html">HISTORY</a></li>
              </ul>
            </li>
            <li class="nav-item">
          ...
          <a href="#" class="text-decoration-none text-dark"><i class="bi bi-whatsapp fs-2 me-3"></i></a>
        </div>
      </div>
    </nav>               
      ...
      <div class="container px-4">
        ...
        <div class="row">
          <div class="col-6 col-lg-4">
            <h3 class="pt-3 fw-bold">RICE TRUST</h3>
            <p>Rural Integrated Childcare And Education Trust</p>
            <p>119, LOURDHU NAGAR 
              MELAMANJAMPATTY-621307
              MANAPARAI TALUK
              TRICHY DISTRICT,
              TAMIL NADU, INDIA
            </p>
            <p class="mb-0">+91 996550741</p>
          </div>
          <div class="col">
            <h3 class="pt-3 fw-bold">Who We Are</h3>
            <ul class="list-unstyle">
             <li><a href="" class="text-decoration-none text-light">*Where We Work</a>
              <li><a href="" class="text-decoration-none text-light">*Accountability</a>
                <li><a href="" class="text-decoration-none text-light">*Tribute</a>
                  <li><a href="" class="text-decoration-none text-light">*Newsletter</a>
  
            </ul>
          </div>
          <div class="col" class="list-unstyle">
            <h3 class="pt-3 fw-bold">What We Do</h3>
            <li><a href="" class="text-decoration-none text-light">Educational_Sponsorship</a>
              <li><a href="" class="text-decoration-none text-light">Coummnity Health</a>
                <li><a href="" class="text-decoration-none text-light">Vocatinal Training</a>
                  <li><a href="" class="text-decoration-none text-light">Study Centers</a>
          </div>
          <div class="col" class="list-unstyle">
            <h3 class="pt-3 fw-bold">Our_+Area_Of_Interest</h3>
            <li><a href="" class="text-decoration-none text-light">Health Care</a>
              <li><a href="" class="text-decoration-none text-light">Sports_and_Games</a>
                <li><a href="" class="text-decoration-none text-light">Awereness_Programs</a>
                  <li><a href="" class="text-decoration-none text-light">Environmental_Protection</a>
                    <li><a href="" class="text-decoration-none text-light">Training_for_Government Jobs</a>
                      <li><a href="" class="text-decoration-none text-light">Counselling_and_Guidance</a>
                        <li><a href="" class="text-decoration-none text-light">Naturopathy</a>
          </div>
          <div  class="col-6 col-lg-3 text-lg-end">
            ...
            <div>
              ...
              <a href="#" class="text-decoration-none text-light"><i class="bi bi-messenger fs-2"></i></a>
              <a href="#" class="text-decoration-none text-light"><i class="bi bi-telephone-forward fs-2"></i></a>
            </div>
          </div>
        </div>
        <hr>
        <div class="d-flex justify-content-between">
          <p>2025 @ condintions . All rights Reserved</p>
          <div class="d-flex">
